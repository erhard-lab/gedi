...
public class MutableOctuple<T1, T2, T3, T4, T5, T6, T7, T8> implements Comparable<MutableOctuple<T1,T2,T3,T4,T5,T6,T7,T8>>,Mutable {
	...
	public MutableOctuple() {
		this(null,null,null,null,null,null,null,null);
	}
	public MutableOctuple(T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6, T7 i7, T8 i8) {
		Item1 = i1;
		Item2 = i2;
		Item3 = i3;
		Item4 = i4;
	...
	public MutableOctuple<T1,T2,T3,T4,T5,T6,T7,T8> set(T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6, T7 i7, T8 i8) {
		Item1 = i1;
		Item2 = i2;
		Item3 = i3;
		Item4 = i4;
	...
	public boolean equals(Object obj) {
		if (obj==this) return true;
			...
			MutableOctuple p = (MutableOctuple) obj;
	...
	public int compareTo(MutableOctuple<T1,T2,T3,T4,T5,T6,T7,T8> o) {
		...
		if (re!=0) return re;
		if (Item8 instanceof Comparable)
			re = ((Comparable<T8>)Item8).compareTo(o.Item8);
		return re;
	}
	
	public MutableOctuple<T1,T2,T3,T4,T5,T6,T7,T8> clone() {
		return new MutableOctuple<T1,T2,T3,T4,T5,T6,T7,T8>(Item1,Item2,Item3,Item4,Item5,Item6,Item7,Item8);
	}
