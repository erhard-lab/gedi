...
public class MutableSextuple<T1, T2, T3, T4, T5, T6> implements Comparable<MutableSextuple<T1,T2,T3,T4,T5,T6>>, Mutable {
	...
	public MutableSextuple() {
		this(null,null,null,null,null,null);
	}
	public MutableSextuple(T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6) {
		Item1 = i1;
		Item2 = i2;
		Item3 = i3;
		Item4 = i4;
	...
	public MutableSextuple<T1,T2,T3,T4,T5,T6> set(T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6) {
		Item1 = i1;
		Item2 = i2;
		Item3 = i3;
		Item4 = i4;
	...
	public boolean equals(Object obj) {
		...
		else if (obj instanceof MutableSextuple) {
			MutableSextuple p = (MutableSextuple) obj;
	...
	public MutableSextuple<T1,T2,T3,T4,T5,T6> clone() {
		return new MutableSextuple<T1,T2,T3,T4,T5,T6>(Item1,Item2,Item3,Item4,Item5,Item6);
	}
