...
public class Qk21 implements java.io.Serializable
{
	...
	public static void do_qk21 ( DoubleUnaryOperator integrand, double a, double b, double[] result, double[] abserr, double[] resabs, double[] resasc ) throws Exception
	{
//System.err.println( "do_qk21: a: "+a+"  b: "+b );
		...
		resg = 0;
		fc = integrand.applyAsDouble ( centr );
//double max_fx = fc;
		resk = wgk [ 11-1 ] *fc;
		...
		for ( j = 1 ; j <= 5 ; j++ )
		{
			...
			fval1 = integrand.applyAsDouble ( centr-absc );
//if ( fval1 > max_fx ) max_fx = fval1;
			fval2 = integrand.applyAsDouble ( centr+absc );
...
//System.err.println( "do_qk21: max_fx: "+max_fx+", result: "+result[0]+"  abserr: "+abserr[0] );
	...
	public static void main( String[] args )
	{
		...
		DoubleUnaryOperator integrand = new GaussBump();
...
class GaussBump implements DoubleUnaryOperator
{
